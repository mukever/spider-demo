...
url = 'https://ju.taobao.com/json/tg/ajaxGetItemsV2.json?stype=samount&reverse=down&salesSite=2&type=0&psize=100000&jview=all&actSignIds=31591065&includeForecast=true&page=1&_ksTS=1522642919752_66&callback=jsonp67'
html = requests.get(url)
html_utf8 = bs4.BeautifulSoup(html.content.decode('utf8'))
print(html_utf8)