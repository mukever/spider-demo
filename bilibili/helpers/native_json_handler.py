...
def get_video_info_by_cid(cid,prefer='flv',quality=4):
    ...
    URL_API="http://9bl.bakayun.cn/API/GetVideoUrl.php?type=json&quality=2&cid={}"
    # URL_API="http://interface.bilibili.com/playurl?appkey="+APPKEY+"&otype=json&cid={}&type={}&quality={}"

    video_info = get_url(URL_API.format(cid))
    print(URL_API.format(cid))
    print(video_info)
    try:
        ...
        print(err)
        sys.exit(1)
    print(video_info_dict['Result']['Url']['Main'])
