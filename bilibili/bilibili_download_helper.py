...
import os
import argparse
from  bilibili.helpers.utils import debug,set_debug
from  bilibili.helpers.utils import show_size
from bilibili.helpers.url_generater import generate_urls, get_url_index
from bilibili.helpers import downloaders
from bilibili.helpers import bilibili_info_extractor
from bilibili.helpers import video_process
...
def main():
    ...
    if args.backend == "you-get":
        from bilibili.helpers import you_get_json_handler as url_handler
    elif args.backend == "youtube-dl":
        from bilibili.helpers import youtube_dl_handler as url_handler
    else:
        from bilibili.helpers import native_json_handler as url_handler
